...
var ExpressionEvaluator = exports.ExpressionEvaluator = function () {
   ...
   */
		...
		key: "compoundExpressionEvalLoop",
		value: function compoundExpressionEvalLoop(parsedExpression, key, collectionContext) {
			var evaluated = [];
			...
			try {
				for (var _iterator = parsedExpression[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
   ...
   */
		...
		key: "simpleExpressionEval",
		value: function simpleExpressionEval(expr, key, collectionContext) {
			var breakdown = [],
			    tempstr = "";
			...
			try {
				for (var _iterator2 = breakdown[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					var item = _step2.value;

					if (item != '&&' && item != '||' && item != '^^') {
						var entry = new EntryWrapper(collectionContext.find({ [key]: item }));
